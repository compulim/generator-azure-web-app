...
ECHO Should clean local deployment temp = %CLEAN_LOCAL_DEPLOYMENT_TEMP%
...
IF NOT DEFINED DEPLOYMENT_INTERMEDIATE (
  ECHO Did not define DEPLOYMENT_INTERMEDIATE
  SET DEPLOYMENT_INTERMEDIATE=%DEPLOYMENT_TARGET%\..\intermediate

  IF NOT EXIST "%DEPLOYMENT_INTERMEDIATE%" (
    ECHO Intermediate folder does not exist at %DEPLOYMENT_INTERMEDIATE%
...
IF NOT DEFINED DEPLOYMENT_TEMP (
  ECHO Did not define DEPLOYMENT_TEMP
